...
\subsection{Membership Inference Attack from Output Predictions (Blackbox setting)}
...
\subsection{Membership Inference Attack from Graph Embeddings (Whitebox setting)}
