...
This attack in whitebox setting exploits the fact graph embedding algorithms leave a distinguishable footprint between train and test data records, providing a confidence to the adversary as high as 72\% of accuracy.
