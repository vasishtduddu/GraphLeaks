...
Our analysis indicates serious data privacy risks in graph data processing algorithms and calls for further research to design privacy-preserving embeddings algorithms for graph data.
